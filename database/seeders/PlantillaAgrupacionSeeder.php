...
class PlantillaAgrupacionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $programasData = [
            ...
            4028 => [
                ['ID_AGRUPACION' => 89, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Matemáticas, Probabilidad y Estadística', 'CREDITOS EXIGIDOS' => 27],
                ['ID_AGRUPACION' => 90, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Física', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 91, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Ciencias Básicas', 'CREDITOS EXIGIDOS' => 4],
                ['ID_AGRUPACION' => 92, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Ciencias Sociales, Económicas y Administrativas', 'CREDITOS EXIGIDOS' => 3],
                ['ID_AGRUPACION' => 93, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Ciencias Sociales, Económicas y Administrativas', 'CREDITOS EXIGIDOS' => 3],
                ['ID_AGRUPACION' => 94, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Ingeniería Eléctrica', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 95, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Ingeniería Electrónica', 'CREDITOS EXIGIDOS' => 34],
                ['ID_AGRUPACION' => 96, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Ingeniería de Computación', 'CREDITOS EXIGIDOS' => 11],
                ['ID_AGRUPACION' => 97, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Ingeniería de Computación', 'CREDITOS EXIGIDOS' => 3],
                ['ID_AGRUPACION' => 98, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Optativas - Ingeniería Electrónica', 'CREDITOS EXIGIDOS' => 9],
                ['ID_AGRUPACION' => 99, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Optativas - Ingeniería de Computación', 'CREDITOS EXIGIDOS' => 6],
                ['ID_AGRUPACION' => 100, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Optativas - Ingeniería Eléctrica', 'CREDITOS EXIGIDOS' => 6],
                ['ID_AGRUPACION' => 101, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Trabajo de Grado', 'CREDITOS EXIGIDOS' => 6],
                ['ID_AGRUPACION' => 102, 'ID_COMPONENTE' => 3, 'TIPO_AGRUPACION' => 'LIBRE ELECCIÓN', 'AGRUPACION' => 'Libre Elección', 'CREDITOS EXIGIDOS' => 33],
                ['ID_AGRUPACION' => 103, 'ID_COMPONENTE' => 4, 'TIPO_AGRUPACION' => 'NIVELATORIO', 'AGRUPACION' => 'Nivelatorio', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 104, 'ID_COMPONENTE' => 5, 'TIPO_AGRUPACION' => 'INGLES', 'AGRUPACION' => 'Ingles', 'CREDITOS EXIGIDOS' => 12],
            ],
            4034 => [
                ['ID_AGRUPACION' => 105, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Matemáticas', 'CREDITOS EXIGIDOS' => 40],
                ['ID_AGRUPACION' => 106, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Matemáticas', 'CREDITOS EXIGIDOS' => 4],
                ['ID_AGRUPACION' => 107, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Ciencias Naturales y Estadística', 'CREDITOS EXIGIDOS' => 4],
                ['ID_AGRUPACION' => 108, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Ciencias Naturales y Estadística', 'CREDITOS EXIGIDOS' => 4],
                ['ID_AGRUPACION' => 109, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Programación', 'CREDITOS EXIGIDOS' => 9],
                ['ID_AGRUPACION' => 110, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Humanística', 'CREDITOS EXIGIDOS' => 6],
                ['ID_AGRUPACION' => 111, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Algoritmos y Computación', 'CREDITOS EXIGIDOS' => 10],
                ['ID_AGRUPACION' => 112, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Algoritmos y Computación', 'CREDITOS EXIGIDOS' => 7],
                ['ID_AGRUPACION' => 113, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Sistemas de Cómputo', 'CREDITOS EXIGIDOS' => 3],
                ['ID_AGRUPACION' => 114, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Sistemas de Cómputo', 'CREDITOS EXIGIDOS' => 3],
                ['ID_AGRUPACION' => 115, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Computación Científica', 'CREDITOS EXIGIDOS' => 7],
                ['ID_AGRUPACION' => 116, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Computación Científica', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 117, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Computación Aplicada', 'CREDITOS EXIGIDOS' => 7],
                ['ID_AGRUPACION' => 118, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Trabajo de Grado', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 119, 'ID_COMPONENTE' => 3, 'TIPO_AGRUPACION' => 'LIBRE ELECCIÓN', 'AGRUPACION' => 'Libre Elección', 'CREDITOS EXIGIDOS' => 29],
                ['ID_AGRUPACION' => 120, 'ID_COMPONENTE' => 4, 'TIPO_AGRUPACION' => 'NIVELATORIOS', 'AGRUPACION' => 'Nivelatorios', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 121, 'ID_COMPONENTE' => 5, 'TIPO_AGRUPACION' => 'LENGUA EXTRANJERA', 'AGRUPACION' => 'Inglés', 'CREDITOS EXIGIDOS' => 12],
            ],
            4032 => [
                ['ID_AGRUPACION' => 122, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Matemáticas (Fundamentación)', 'CREDITOS EXIGIDOS' => 32],
                ['ID_AGRUPACION' => 123, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Fundamentación en Física', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 124, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Matemática Aplicada', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 125, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Geometría', 'CREDITOS EXIGIDOS' => 4],
                ['ID_AGRUPACION' => 126, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Disciplinar Optativa', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 127, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Análisis y Topología', 'CREDITOS EXIGIDOS' => 20],
                ['ID_AGRUPACION' => 128, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Matemática Aplicada', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 129, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Algebra y Lógica', 'CREDITOS EXIGIDOS' => 16],
                ['ID_AGRUPACION' => 130, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Trabajo de Grado', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 131, 'ID_COMPONENTE' => 3, 'TIPO_AGRUPACION' => 'LIBRE ELECCIÓN', 'AGRUPACION' => 'Libre Elección', 'CREDITOS EXIGIDOS' => 28],
                ['ID_AGRUPACION' => 132, 'ID_COMPONENTE' => 4, 'TIPO_AGRUPACION' => 'NIVELATORIOS', 'AGRUPACION' => 'Nivelatorios', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 133, 'ID_COMPONENTE' => 5, 'TIPO_AGRUPACION' => 'LENGUA EXTRANJERA', 'AGRUPACION' => 'Inglés', 'CREDITOS EXIGIDOS' => 12],
            ],
            4036 => [
                ['ID_AGRUPACION' => 134, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Fundamentación Matemática', 'CREDITOS EXIGIDOS' => 20],
                ['ID_AGRUPACION' => 135, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Complementación Matemática', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 136, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Complementación Matemática', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 137, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Fundamentación en Ciencias', 'CREDITOS EXIGIDOS' => 3],
                ['ID_AGRUPACION' => 138, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Programación', 'CREDITOS EXIGIDOS' => 7],
                ['ID_AGRUPACION' => 139, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Programación', 'CREDITOS EXIGIDOS' => 3],
                ['ID_AGRUPACION' => 140, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Comunicativa y Humanística', 'CREDITOS EXIGIDOS' => 4],
                ['ID_AGRUPACION' => 141, 'ID_COMPONENTE' => 1, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Comunicativa y Humanística', 'CREDITOS EXIGIDOS' => 4],
                ['ID_AGRUPACION' => 142, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Núcleo Estadístico', 'CREDITOS EXIGIDOS' => 36],
                ['ID_AGRUPACION' => 143, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OPTATIVA', 'AGRUPACION' => 'Complementación Estadística (Disciplinares Optativas - Rutas Curriculares)', 'CREDITOS EXIGIDOS' => 16],
                ['ID_AGRUPACION' => 144, 'ID_COMPONENTE' => 2, 'TIPO_AGRUPACION' => 'OBLIGATORIA', 'AGRUPACION' => 'Consolidación Estadística', 'CREDITOS EXIGIDOS' => 12],
                ['ID_AGRUPACION' => 145, 'ID_COMPONENTE' => 3, 'TIPO_AGRUPACION' => 'LIBRE ELECCIÓN', 'AGRUPACION' => 'Libre Elección', 'CREDITOS EXIGIDOS' => 30],
                ['ID_AGRUPACION' => 146, 'ID_COMPONENTE' => 4, 'TIPO_AGRUPACION' => 'NIVELATORIO', 'AGRUPACION' => 'Nivelatorio', 'CREDITOS EXIGIDOS' => 8],
                ['ID_AGRUPACION' => 147, 'ID_COMPONENTE' => 5, 'TIPO_AGRUPACION' => 'INGLES', 'AGRUPACION' => 'Inglés', 'CREDITOS EXIGIDOS' => 12],
            ],
        ];
